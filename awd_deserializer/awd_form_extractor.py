...
class XMLFormGenerator:
    ...
    def _create_field_element(self, field: dict[str, Any], index: int) -> ET.Element | None:
...
class AWDFormExtractor(ComponentExtractor):
    ...
    async def _extract_general_form(self, content: str, context: ExtractionContext) -> dict[str, Any] | None:
