...
class ValidationFramework:
    ...
    async def _find_reference_file(self, component_type: str, component_name: str) -> str | None:
    ...
    async def _validate_data_type(self, generated: str, reference: str) -> dict[str, Any]:
        ...
        try:
            ...
            for element in xml_elements:
                if element in generated_content and element in reference_content or element not in generated_content and element not in reference_content:
                    score += 0.33
                else:
...
class ComponentExtractor(ABC):
    ...
    def __init__(self, extractor_name: str):
        ...
        self.validation_framework: ValidationFramework | None = None
...
class ComponentExtractionOrchestrator:
    ...
    def __init__(self):
        ...
        self.extraction_semaphore: asyncio.Semaphore | None = None
