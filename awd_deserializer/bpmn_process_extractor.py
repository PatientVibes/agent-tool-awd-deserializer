...
class BPMNProcessExtractor(ComponentExtractor):
    ...
    def _extract_single_process(self, component: AWDComponent) -> Optional[BPMNProcessInfo]:
    ...
    def _get_xml_content(self, component: AWDComponent) -> Optional[str]:
    ...
    def _extract_xml_from_data(self, data: Any) -> Optional[str]:
    ...
    def _extract_xml_from_string(self, content: str) -> Optional[str]:
    ...
    def _detect_xml_end(self, xml_content: str) -> Optional[str]:
    ...
    def _clean_bpmn_xml(self, xml_content: str) -> Optional[str]:
    ...
    def _fix_xml_issues(self, xml_content: str) -> Optional[str]:
    ...
    def _parse_bpmn_xml(self, xml_content: str, component: AWDComponent) -> Optional[BPMNProcessInfo]:
...
def extract_bpmn_processes(awd_json: Dict[str, Any], output_dir: Optional[Path] = None) -> List[BPMNProcessInfo]:
    """
