...
class AWDDataParser:
    ...
    def parse(self, awd_json: str | dict[str, Any]) -> list[AWDComponent]:
        """
    ...
    def _extract_bpmn_component(self, data: dict[str, Any], path: str) -> AWDComponent | None:
    ...
    def _extract_form_component(self, data: dict[str, Any], path: str) -> AWDComponent | None:
    ...
    def _extract_service_component(self, data: dict[str, Any], path: str) -> AWDComponent | None:
    ...
    def _extract_data_type_component(self, data: dict[str, Any], path: str) -> AWDComponent | None:
    ...
    def _extract_xml_content(self, data: dict[str, Any]) -> str | None:
        ...
        for key in ["definition", "content", "xml", "data", "_value"]:
            ...
            if value and isinstance(value, str):
                ...
                elif value.strip().startswith('<?xml') or '<bpmn:' in value or len(value) > 100 and '<bpmn:' in value:
                    return value

        # Also search recursively for any string containing BPMN XML
        return self._search_for_bpmn_xml(data)

    def _search_for_bpmn_xml(self, data: Any) -> str | None:
    ...
    def _extract_process_name(self, data: dict[str, Any], xml_content: str | None) -> str | None:
    ...
    def _extract_process_id(self, data: dict[str, Any], xml_content: str | None) -> str | None:
    ...
    def _extract_form_name(self, data: dict[str, Any]) -> str | None:
    ...
    def _extract_form_id(self, data: dict[str, Any]) -> str | None:
    ...
    def _extract_service_name(self, data: dict[str, Any]) -> str | None:
        """Extract service name from data."""
        return (self._get_nested_value(data, "name._value") or
                self._get_nested_value(data, "serviceName._value"))

    def _extract_service_id(self, data: dict[str, Any]) -> str | None:
    ...
    def _extract_type_name(self, data: dict[str, Any]) -> str | None:
    ...
    def _extract_type_id(self, data: dict[str, Any]) -> str | None:
        """Extract data type ID from data."""
        return (self._get_nested_value(data, "id._value") or
                self._get_nested_value(data, "typeId._value"))

    def _extract_service_type(self, data: dict[str, Any]) -> str | None:
    ...
    def _extract_screen_format(self, data: dict[str, Any]) -> str | None:
...
def parse_awd_json(awd_json: str | dict[str, Any]) -> list[AWDComponent]:
    """
